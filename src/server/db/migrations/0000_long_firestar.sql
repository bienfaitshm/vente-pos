...
CREATE TYPE "public"."status" AS ENUM('OPEN', 'CLOSE', 'RENOVATION');--> statement-breakpoint
CREATE TYPE "public"."action" AS ENUM('ADD', 'REMOVE');--> statement-breakpoint
...
CREATE TABLE "stock_histories" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"quantity" integer NOT NULL,
	"action" "action" DEFAULT 'ADD' NOT NULL,
...
ALTER TABLE "order_details" ADD CONSTRAINT "order_details_order_id_customers_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."customers"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
